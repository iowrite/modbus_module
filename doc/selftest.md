...
|    | 0x04          | slave     | 正常读取       | 01 04 00 64 00 0b f0 12                              | 01 04 16 00 00 00 01 00 02 00 03 00 04 00 05 00 06 00 07 00 08 00 09 00 0a 1a 38 | v      |                                                |
|    |               | slave     | 地址不合法     | [01][04][00][78][00][0B][31][D4]                     | <01><84><02>`<C2><C1>`                                                         | v      |                                                |
...
|    | 04            | master     | 正常读取          | 01 04 00 69 00 01 e1 d6                                                                | modbus_rtu_read_input | 01 04 02 00 05 79 33                   | modbus_rtu_opt_status | 0            | v      |          |
|    |               | master     | 无回复            | 01 04 00 69 00 01 e1 d6                                                                | modbus_rtu_read_input | 无                                     | modbus_rtu_opt_status | -1           | v      |          |
|    |               | master     | 地址无效/长度过长 | 01 04 00 69 00 0a a0 11                                                                | modbus_rtu_read_input | 01 84 02 c2 c1                         | modbus_rtu_opt_status | -1           | v      |          |
|    |               |            |                   |                                                                                        |                       |                                        |                       |              |        |          |
