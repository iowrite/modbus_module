 ...
 * @return 0 成功，-1 失败
 */
int8_t modbus_rtu_read_hold(eModebus_RTU_Bus_def bus, uint8_t dev_addr, uint16_t usReg_addr, uint16_t reg_num, uint16_t *reg_data);
...
int8_t modbus_rtu_write_hold(eModebus_RTU_Bus_def bus, uint8_t dev_addr, uint16_t usReg_addr, uint16_t reg_num, uint16_t *reg_data);
