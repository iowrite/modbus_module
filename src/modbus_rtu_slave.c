...
/**
  *************************************************************************************************
  * @Function    : modbus_fun_parse_slave
  * @Description : 
  * @Parameter   : handler 处理句柄
  * @Parameter   : buff 接收到的数据缓存
...
/**
  *************************************************************************************************
  * @Function    : modbus_fun_parse_slave_03
  * @Description : 
  * @Parameter   : handler 处理句柄
  * @Parameter   : buff 接收到的数据缓存
  * @Parameter   : len 接收到的数据长度
...
/**
  *************************************************************************************************
  * @Function    : modbus_fun_parse_slave_04
  * @Description : 
  * @Parameter   : handler 处理句柄
  * @Parameter   : buff 接收到的数据缓存
  * @Parameter   : len 接收到的数据长度
...
int8_t modbus_fun_parse_slave_04(stModbus_RTU_Handler_def *handler, uint8_t *buff, uint16_t len)
{
    ...
    ret = handler->pRead_input_def(&reader);
    if(ret == 0)
    {
        handler->ucTx_buff[0] = handler->ucDev_addr;
...
/**
  *************************************************************************************************
  * @Function    : modbus_fun_parse_slave_06
  * @Description : 
  * @Parameter   : handler 处理句柄
  * @Parameter   : buff 接收到的数据缓存
  * @Parameter   : len 接收到的数据长度
...
/**
  *************************************************************************************************
  * @Function    : modbus_fun_parse_slave_10
  * @Description : 
  * @Parameter   : handler 处理句柄
  * @Parameter   : buff 接收到的数据缓存
  * @Parameter   : len 接收到的数据长度
